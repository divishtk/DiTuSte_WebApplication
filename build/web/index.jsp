        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-sm-7 col-lg-4">
                <form action="/DiTuSte_Cryto/loginServlet" method="GET" class="form-signin border border-primary rounded shadow p-5 mb-3">
                    ...
                    <input type="text" id="inputEmail" name="uname" class="form-control m-1" placeholder="Email address" required="" autofocus="" value="steven123">
                    <label for= "inputPassword" class="sr-only">Password</label>
                    <input type="password" id="inputPassword" name="upass" class="form-control m-1" placeholder="Password" required="" value="qwerty123">
